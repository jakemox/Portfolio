            ...
            <div class="projects">
                <div class="img photo1">
                    <a class="project1" href="http://scratchmyapp.com" target="blank">
                        <div class="place hover1">
                            <span class="folio-title">ScratchMyApp</span>
                        </div>
                    </a>
                </div>
                <div class="img photo2">
                    <a class="project1" href="/weather-app" target="blank">
                        <div class="place hover2">
                            <span class="folio-title">Weather App</span>
                ...
                <div class="img photo3">
                    <a class="project1" href="/sky-scammer" target="blank">
                        <div class="place hover3">
                            <span class="folio-title">Flight App</span>
                            <span class="tech">(React)</span>
                        </div>
                    </a>
                </div>
                <div class="img photo4">
                    <a class="project1" href="/exchange-rates" target="blank">
                        <div class="place hover4">
                            <span class="folio-title">Exchange Rates</span>
    ...
    <section class="myskills" id="skills">
        <div class="container">
            ...
            <div class="progress">
                ...
                <div class="bar">
                    <div class="knob" style="width: 40%"></div>
                </div>
            </div>
            <div class="progress">
    ...
    <section class="aboutme" id="info">
        <div class="container">
            ...
            <div class="about-content">
                ...
                <div class="text">
                    <p>
                    A keen and creative Junior Developer, I have recently enhanced my skills in web development by studying for 3 months in an intensive Coding Bootcamp. I am seeking a role in which I can work in a great team to further develop my Javascript and OOP skills while making a meaningful contribution. Combining my coding skills with my keen eye for design, I have a good base to build upon and am eager for a challenge. My reliability and willingness to learn make me a valuable asset to any team and I am hungry to fulfil my potential as a web developer.
                    </p>
                </div>
            </div>
        </div>
    ...
    <section class="findme">
        <div class="container">
            ...
            <div class="social">
                ...
                <a href="https://www.linkedin.com/in/jakemox/" target="_blank"><img class="icons" src="images/linkedin.svg" alt="linkedIn"></a>
            </div>
        </div>
    </section>
